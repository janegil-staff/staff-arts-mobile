...
import CreateShowScreen from "../screens/shows/CreateShowScreen";
    ...
    >
      ...
      <Text
        style={{
          fontSize: 11,
          color: focused ? c.teal : c.textMuted,
          fontWeight: focused ? fw.bold : fw.medium,
          letterSpacing: 0.3,
        }}
      >
        {label}
        ...
        options={{
          headerTitle: function () {
            return (
              ...
              >
                STAFF{" "}
                <Text style={{ color: c.teal, fontStyle: "italic" }}>Arts</Text>
              </Text>
            );
          },
        }}
  ...
  return (
    ...
    >
      <Tab.Screen
        ...
        options={{
          tabBarIcon: function ({ focused }) {
            return <TabIcon label="Home" icon="🏠" focused={focused} />;
          },
        }}
      />
      <Tab.Screen
        ...
        options={{
          tabBarIcon: function ({ focused }) {
            return <TabIcon label="Explore" icon="🔍" focused={focused} />;
          },
        }}
      />
      <Tab.Screen
      ...
      <Tab.Screen
        ...
        options={{
          tabBarIcon: function ({ focused }) {
            return <TabIcon label="Shows" icon="🎭" focused={focused} />;
          },
        }}
      />
      <Tab.Screen
        ...
        options={{
          tabBarIcon: function ({ focused }) {
            return <TabIcon label="Profile" icon="👤" focused={focused} />;
          },
        }}
      />
    </Tab.Navigator>
